...
alias cs="ssh kvosbur@data.cs.purdue.edu"
alias data="kvosbur@data.cs.purdue.edu"
alias home="ssh kvosbur@kevinvosburgh.com"
alias homet="ssh team@kevinvosburgh.com"
...
alias taste="cd /home/team/Projects/TasteTradeServer && ls"
